<template>
  <div>
    <el-card>
      ...
      <el-button type="success" size="small" class="btn" @click="UploadExecl" style="margin-left: 620px">上传execl文件
      </el-button>
    ...
    <el-dialog title="上传Execl文件" :visible.sync="ExeclDialog" width="30%">
      <el-upload :on-change="onUploadChange" ref="upload" on :file-list="fileList" :auto-upload="false"
