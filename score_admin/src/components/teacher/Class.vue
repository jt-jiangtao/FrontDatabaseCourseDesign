<template>
  <div>
    <el-card>
      ...
      <!-- 表格区域 -->
      <el-table :data="classInfo.courses" border size="small" style="width: 100%; margin-top: 10px">
        <el-table-column align="center" prop="id" label="课程号" width="80"> </el-table-column>
        ...
        <el-table-column align="center" prop="time" label="课时" width="80"> </el-table-column>
        <el-table-column align="center" prop="score" label="学分" width="80"> </el-table-column>
        <el-table-column align="center" prop="property" label="课程类型"> </el-table-column>
      </el-table>
    </el-card>
  </div>
