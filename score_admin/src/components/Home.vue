  ...
  <div>
    <el-container>
      <el-aside :width="iscollapse ? '64px' : '200px'">
        <el-menu :collapse-transition="false" :collapse="iscollapse" unique-opened background-color="#304156" default-active="" text-color="#BFCBD9" class="el-menu-vertical-demo" router>
          <el-submenu index="1">
            <template slot="title">
