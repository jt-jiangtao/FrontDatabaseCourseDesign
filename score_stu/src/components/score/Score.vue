  ...
  <div>
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="time" label="考核时间" align="center">
        </el-table-column>
        <el-table-column
          prop="name"
          label="考核类型"
      ...
      >
        ...
        <el-table-column prop="property" label="课程类型" align="center">
        </el-table-column>
        <el-table-column prop="studyMode" label="修读方式" align="center">
        </el-table-column>
        <el-table-column prop="score" label="学分" width="180" align="center">
        </el-table-column>
        <el-table-column prop="grade" label="成绩" width="180" align="center">
        </el-table-column>
        <el-table-column prop="r" label="班级排名" width="180" align="center">
        </el-table-column>
      </el-table>
    </el-card>
  </div>
  ...
  methods: {
    ...
    async searchScore() {
      ...
      const { data: res } = await this.$http.post(
        "api/student/score",
        this.qs.stringify(this.scoreQuery)
      );
