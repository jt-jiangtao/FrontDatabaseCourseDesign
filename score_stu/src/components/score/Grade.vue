  ...
  <div>
    <el-card class="box-card">
      <div style="display: flex">
        ...
        <el-button style="margin-left: 300px" type="primary" size="small" @click="searchGpa()">查询</el-button>
      </div>

      <!-- 绩点表格 -->
      <el-table :data="gpaInfo" border style="width: 100%; margin-top: 10px" size="small">
...
export default {
  ...
  methods: {
    async searchGpa() {
      const { data: res } = await this.$http.post('api/student/gpa', this.qs.stringify(this.gpaQuery))
